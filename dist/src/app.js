...
const controller_7 = __importDefault(require("./routes/company_detail/controller"));
const controller_8 = __importDefault(require("./routes/apply/controller"));
const controller_9 = __importDefault(require("./routes/comparison/controller"));
const controller_10 = __importDefault(require("./routes/main/controller"));
...
app.use("/api/company-detail", controller_7.default);
app.use("/api/apply", controller_8.default);
app.use("/api/comparison", controller_9.default);
app.use("/api/main", controller_10.default);
